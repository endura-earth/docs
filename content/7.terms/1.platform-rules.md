...
The FirstRand Group of Companies' simplified legal entity structure can be found on the group's website at: `https://www.firstrand.co.za/the-group/ownership-and-legal-structure`
...
- an authorised individual, representing a juristic or non-juristic entity in a different capacity, like an executor of a deceased estate, a curator or a liquidator.
...
If we accept your registration as a user, you will be allocated a FirstID. Your FirstID is a unique identifier that creates a single user profile for you, by collating all information relevant to you and your interactions across our Platform, whether you are transacting with us or any independent third-party service provider.
